 ...
 * skipped, while every other safety net (files must exist, categories configured, cross-shard
 * duplicate check, never-overwrite) still applies. {@code ApplyEngine.resolveCorruptSidecar()}
