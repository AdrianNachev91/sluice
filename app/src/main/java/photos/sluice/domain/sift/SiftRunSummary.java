...
/**
 * One sift run as it currently sits on disk: which scope it belongs to, how
 ...
 *         be read
 */
public record SiftRunSummary(String scope, Path prepDir, PrepDirHealth health, @Nullable ShardTally shards,
                             Instant since) {
}
