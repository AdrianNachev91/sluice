...
import photos.sluice.domain.sift.Finding.VerdictUnreviewableOverlap;
import photos.sluice.domain.sift.Finding.DuplicateFileReference;
import photos.sluice.domain.sift.Finding.FileOutOfScope;
import photos.sluice.domain.sift.Finding.FillerReason;
import photos.sluice.domain.sift.Finding.GroupSpansMultipleMontages;
import photos.sluice.domain.sift.Finding.InvalidCategory;
import photos.sluice.domain.sift.Finding.InvalidGroupSlug;
import photos.sluice.domain.sift.Finding.MissingChosenReason;
import photos.sluice.domain.sift.Finding.MissingFile;
import photos.sluice.domain.sift.Finding.MissingGroup;
import photos.sluice.domain.sift.Finding.MissingMontageField;
import photos.sluice.domain.sift.Finding.MissingReason;
import photos.sluice.domain.sift.Finding.MontageFieldMismatch;
import photos.sluice.domain.sift.Finding.PhotosNotJudged;
import photos.sluice.domain.sift.Finding.TooFewRejects;
import photos.sluice.domain.sift.Finding.WrongChosenCount;
 ...
 * truth for what a well-formed sift looks like. It reports every representable-but-wrong problem
...
public final class ShardValidator {
     ...
     * or re-pointed to the unique sidecar src sharing its basename, which is a sieve having
