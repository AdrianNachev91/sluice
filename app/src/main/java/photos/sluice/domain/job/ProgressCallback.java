 ...
 * shard applied.
 *
 * <p>{@code total} is fixed across every call in a given run. It rides on every tick rather than
 * being announced separately up front, so nothing has to know it before the work starts.
 */
@FunctionalInterface
