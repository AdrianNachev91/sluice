...
/**
 * Where a sifted file ends up. One decision maps to exactly one destination directory, and this is
...
public class SiftDestinations {
     ...
     */
    public SiftDestinations(final PathsPort pathsPort) {
     ...
     * the day is long gone by the time a sift runs.
     *
     ...
     * before a sift touches a file, and the mirror of {@link #under}'s refusal on the destination
