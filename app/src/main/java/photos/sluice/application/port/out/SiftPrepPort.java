...
public interface SiftPrepPort {
     ...
     * parse means the prep dir itself is corrupt, not a fixable sifting mistake, and throws
     ...
     * same distinction {@link #readIndex} makes against a plain {@link UncheckedIOException} for a
     * read that merely failed. A shard is the sifting agent's own output, not this app's. So
