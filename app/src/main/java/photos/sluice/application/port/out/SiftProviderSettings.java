 ...
 * A provider that cannot work without a field (the model id, say) checks it at sift time and fails
 ...
 *     into one.
 */
public record SiftProviderSettings(@Nullable String model, @Nullable String endpoint,
    ...
    private static final SiftProviderSettings UNSET = new SiftProviderSettings(null, null, null);
     ...
     *
     * @return {@link SiftProviderSettings} settings with no field set
     */
    public static SiftProviderSettings unset() {
        return UNSET;
    }
