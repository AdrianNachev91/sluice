 ...
 * decoding the whole file into memory. Returns empty when the dimensions cannot be determined,
 * letting a caller degrade gracefully rather than fail the whole run.
 */
