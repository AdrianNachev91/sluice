...
/**
 * The effect boundary application services use to render montage contact sheets for a sift scope,
 * producing the prep directory a vision provider then judges.
 */
public interface MontageRenderer {

    /**
     * Builds montage contact sheets for a sift scope.
     *
     * @param scope {@link SiftScope} the media scope to render montages for
     ...
     */
    PrepDir build(SiftScope scope, MontageConfig config);
     ...
     * @return {@link PrepDir} the prep directory holding the built montages
     */
    default PrepDir build(final SiftScope scope, final MontageConfig config, final ProgressCallback progress) {
     ...
     */
    default @Nullable PrepDir build(final SiftScope scope, final MontageConfig config, final ProgressCallback progress,
