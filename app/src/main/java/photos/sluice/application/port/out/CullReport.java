 ...
 * short only by explicit {@code allowPartial} waivers) returns one; anything less throws instead.
 *
 * <p>{@code montagesCulled} counts montages whose valid shard this run produced fresh judgement
 * for. Meanwhile {@code montagesSkipped} counts montages that got none: waived by
 * {@code allowPartial}, or already holding a valid shard from an earlier interrupted run.
 *
