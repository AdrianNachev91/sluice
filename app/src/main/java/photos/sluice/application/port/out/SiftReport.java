...
/**
 * Outcome summary of a sift: what it judged, what it consumed, and whether it stopped short of the
 * work it was given.
 *
 ...
 * {@code allowPartial}, already holding a shard from an earlier interrupted run, or unsifted for
 * want of a readable sidecar.
 *
 * <p>Sifted and skipped need not sum to the montage count. A run stopped early by a cancellation or
 ...
 *
 * @param montagesSifted how many montages this run obtained fresh judgement for
 ...
 */
public record SiftReport(int montagesSifted, int montagesSkipped, int apiCalls, TokenSpend spend,
                         boolean stoppedAtCeiling) {

    /**
     * A report of a sift that judged nothing and consumed nothing.
     *
     ...
     * @return {@link SiftReport} a zero report attributed to that provider
     */
    public static SiftReport nothingSpent(final String providerId, final int montagesSkipped) {
        return new SiftReport(0, montagesSkipped, 0, TokenSpend.none(providerId), false);
    }
}
