 ...
 * {@link SiftException} thrown out of {@link VisionSieve#sift}.
 *
...
public enum ProviderType {
    ...
    /**
     * The app calls a model and writes the shards from its answer. A {@link SiftException} means
     ...
     * {@link SiftException} means no complete, valid shard set yet. That is the ordinary pause
