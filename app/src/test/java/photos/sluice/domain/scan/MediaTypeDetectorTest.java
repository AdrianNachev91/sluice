...
class MediaTypeDetectorTest {
    ...
    void classifiesPhotoExtensions(String extension) {
        Optional<MediaType> result = detector.classify(Path.of("IMG_1234." + extension));
    ...
    void classifiesVideoExtensions(String extension) {
        Optional<MediaType> result = detector.classify(Path.of("VID_1234." + extension));
    ...
    void classificationIsCaseInsensitive(String extension) {
        Optional<MediaType> result = detector.classify(Path.of("IMG_1234." + extension));
    ...
    void returnsEmptyForUnrecognizedExtension(String extension) {
        Optional<MediaType> result = detector.classify(Path.of("file." + extension));
    ...
    void returnsEmptyForFileWithNoExtension() {
        Optional<MediaType> result = detector.classify(Path.of("README"));
