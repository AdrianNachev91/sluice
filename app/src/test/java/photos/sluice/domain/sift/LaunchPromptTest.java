...
class LaunchPromptTest {
    ...
    private static PrepDir prep(final SiftCategory... categories) {
    ...
    private static SiftCategory junk() {
        return new SiftCategory("junk", "Screenshots, blurred shots and photos of paper.",
                List.of("a receipt", "a blurred shot"), true);
    }

    private static SiftCategory scenery() {
        return new SiftCategory("scenery", "A landscape with nobody in it.", List.of(), true);
    }
}
