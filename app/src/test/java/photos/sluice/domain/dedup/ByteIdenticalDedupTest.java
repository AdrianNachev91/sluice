...
class ByteIdenticalDedupTest {
    ...
    void distinctHashesAllGoToSortInOrder() {
        ...
        final DedupPlan plan = dedup.plan(List.of(a, b), Set.of());
    ...
    void secondOccurrenceOfSameHashWithinBatchIsMarkedDuplicate() {
        ...
        final DedupPlan plan = dedup.plan(List.of(first, second), Set.of());
    ...
    void hashPresentInLibraryIsMarkedRedundant() {
        ...
        final DedupPlan plan = dedup.plan(List.of(inLibrary), Set.of("libHash"));
    ...
    void libraryRedundancyTakesPriorityOverBatchDedupForEveryOccurrence() {
        ...
        final DedupPlan plan = dedup.plan(List.of(first, second), Set.of("libHash"));
    ...
    void mixedBatchPartitionsEachFileIntoTheCorrectBucketWithoutCrossContamination() {
        ...
        final DedupPlan plan = dedup.plan(List.of(distinct, dupFirst, dupSecond, libRedundant), Set.of("libHash"));
    ...
    void emptyInputProducesEmptyPlan() {
        final DedupPlan plan = dedup.plan(List.of(), Set.of());
