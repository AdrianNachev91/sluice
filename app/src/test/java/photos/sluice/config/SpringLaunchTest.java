...
class SpringLaunchTest {
    ...
    void theConfigFileIsImported() {
        ...
        final String[] args = SpringLaunch.importing(configFile, new String[0]);
    ...
    void theImportIsOptional() {
        final String[] args = SpringLaunch.importing(Path.of("config.yml"), new String[0]);
    ...
    void theCallersOwnArgumentsComeAfterTheImport() {
        final String[] args = SpringLaunch.importing(Path.of("config.yml"),
